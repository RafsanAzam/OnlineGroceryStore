    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                ...
                new Category { CategoryId = 2, Name = "Vegetables", ImageUrl = "/images/cat-3.png" },
                new Category { CategoryId = 3, Name = "Dairy", ImageUrl = "/images/dairy.jpg" },
                new Category { CategoryId = 4, Name = "Beverages", ImageUrl = "/images/beverages.jpg" }
            );
